        ...
        return Container(
            content=Column(
                [
                    ...
                    Text("• At least an uppercase letter.", color="black", size=15),
                    Text("• At least an lowercase letter.", color="black", size=15),
                    Text("• At least a number.", color="black", size=15),
                    Text("• At least a unique symbol.", color="black", size=15),
                    Text("• At least 8 characters.", color="black", size=15),
                ],
